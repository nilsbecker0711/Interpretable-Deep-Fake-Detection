...
#SBATCH --mem=20000             # Memory request (adjust as needed)
...
torchrun --nproc_per_node=2 --nnodes=1 --node_rank=0 --master_addr="localhost" --master_port=29500 ~/Interpretable-Deep-Fake-Detection/training/train.py --detector_path ~/Interpretable-Deep-Fake-Detection/training/config/config/detector/inception_bcos.yaml --ddp