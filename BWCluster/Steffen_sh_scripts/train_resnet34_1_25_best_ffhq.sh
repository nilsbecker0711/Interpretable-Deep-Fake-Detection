...
#SBATCH -t 03:30:00            # Time limit (10 minutes for debugging purposes)
...
python ~/Interpretable-Deep-Fake-Detection/training/train.py --detector_path ~/Interpretable-Deep-Fake-Detection/training/config/detector/resnet34_bcos_v2_1_25_best_hpo_ffhq.yaml
