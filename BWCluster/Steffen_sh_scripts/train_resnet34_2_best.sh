...
python /BS/robust-architectures/work/bcos-df/training/train.py --detector_path /BS/robust-architectures/work/bcos-df/training/config/detector/resnet34_bcos_v2_2_best_hpo.yaml
