...
python /home/ma/ma_ma/ma_kreffert/interpretable-deep-fake-detection/data/raw/faceforensics_download_v4.py /home/ma/ma_ma/ma_kreffert/interpretable-deep-fake-detection/DeepfakeBench/datasets/rgb/FaceForensics++ -d all -c c40 -t videos --server EU2
